...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới DAL SEEN..."),
        ...
        ("install_tip", "Do cơ chế UAC, DAL SEEN có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt DAL SEEN vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho DAL SEEN."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho DAL SEEN."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [DAL SEEN Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep RustDesk background service", "Giữ dịch vụ DAL SEEN chạy nền"),
        ...
        ("verify_rustdesk_password_tip", "Xác thực mật khẩu DAL SEEN"),
        ...
        ("scam_text2", "Chỉ sử dụng DAL SEEN với những người bạn thực sự tin tưởng."),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ DAL SEEN mở"),
        ...
        ("floating_window_tip", "Giữ DAL SEEN trên cùng"),
